...
from .modeling_openpangu_v2 import OpenPanguV2Model


# GPU port: torch_npu unconditional import removed; conditional version below
# sets NPU_ATTN_INFR=False on non-NPU machines, and the attention call sites
# fall back to ALL_ATTENTION_FUNCTIONS / SDPA.
...
class OpenPanguVLModel(OpenPanguPreTrainedModel):
    ...
    def _parse_preprocess_params(self, vision_config):
        ...
        processor = AutoProcessor.from_pretrained(
            self.config.name_or_path, trust_remote_code=True, local_files_only=True
        )
