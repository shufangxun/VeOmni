...
class OpenPanguV2Experts(nn.Module):
    ...
    def forward(
        ...
        final_hidden_states = torch.zeros_like(hidden_states)  # batch_size, tokens, hidden_dim
        with torch.no_grad():
            expert_mask = torch.nn.functional.one_hot(
                top_k_index, num_classes=self.num_experts
            )  # batch_size, tokens, experts
            expert_mask = expert_mask.permute(2, 1, 0)  # experts, tokens, batch_size
