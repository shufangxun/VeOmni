...
class OpenPanguV2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        sliding_window: int | list[int] | None = 127,
        ...
        mhc_use_gamma: bool | None = True,
        mhc_recur_norm: int | None = 20,
        mhc_num_stream: int | None = 4,
        **kwargs,
    ):
        ...
        if layer_types is None and swa_layers is not None:
            self.layer_types = [
                "sliding_attention" if self.sliding_window is not None and i in swa_layers else "full_attention"
